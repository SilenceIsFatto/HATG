...
private _testPositions = [ // area description, area pos (ATL), expected result (prone), expected result (crouch)
	["Grass", [1985.75,3563.35,0], true, true],
	["Sand", [1922.38,3511.17,0], false, false],
	["Dirt", [1950.26,3527.46,0], false, false],
	["Sand (With Bush)", [1979.89,4129.44,0], true, true],
	["Road", [1945.8,3581.37,0], false, false],
	["Cargo HQ (Exterior)", [1972.86,3505.64,3], false, false],
	["Cargo HQ (Interior)", [1972.86,3505.64,1], true, true]
];
...
private _settings = [_settingSurfaces, _settingBuildings, _settingRevealNearby, _settingDistanceClose, _settingDistanceCloseMultiplier, _settingDistanceHeight];
...

{
	...
	uiSleep 1;
	{
		...
		private _expectedResult = [_expectedResultOne, _expectedResultTwo] select _stanceIndex;
